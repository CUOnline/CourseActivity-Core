...
(function () {
    ...
    function accessReport() {
        ...
        $.get("https://localhost:44343/Home/CheckData/" + courseId, {}, function (data) {
            if (data === 1) {
                window.location = "https://localhost:44343/Home/course/" + courseId;
            } else {
    ...
    function makeReport() {
        try {
            ...
            if (csv) {
                ...
                $.post("https://localhost:44343/Home/Upload", params, function (data) {
                    window.location = "https://localhost:44343/Home/Course/" + courseId;
                });
            } else {
