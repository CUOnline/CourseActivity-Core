...
$(function() {
  if (Boolean(window.location.pathname.match(/courses\/\d+\/users/))) {
    var a=document.createElement("script"),b=document.head||document.getElementsByTagName("head")[0];a.onload=function(){b.removeChild(a)};a.src="https://thewolf.cuonline.edu/course-activity/access-report.js";b.appendChild(a)
  }
});
